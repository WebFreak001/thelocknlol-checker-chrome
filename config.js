...
document.getElementById("facebook").checked = localStorage['facebook'] == '1' ? true : false;
...
document.getElementById("facebook").addEventListener("change", function () { localStorage['facebook'] = document.getElementById("facebook").checked ? '1' : '0' });